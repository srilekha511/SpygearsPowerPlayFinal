...
// @Disabled
public class RedAuton1NoTensorFlowTest extends LinearOpMode {
    ...
    private double linearSlideMed = 24;
...
*/
        ...
        //close the servo
        //  servoOpen(servoarm);
        // slideMotorUp(LinearSlideMotor, (int) linearSlideMed);
        //slideMotorUpTest(1,0.1);
        slideMotorUpTest(23, 0.1);
...
*/
    ...
    private void slideMotorUp(DcMotor LinearSlideMotor, int howMuch) {
